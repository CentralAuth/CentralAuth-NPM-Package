...
exports.CentralAuthHTTPClass = exports.CentralAuthClass = exports.hash = exports.ValidationError = exports.canStale = void 0;
const axios_1 = __importDefault(require("axios"));
const axios_cache_interceptor_1 = require("axios-cache-interceptor");
const jose_1 = require("jose");
//Reexport of canStale
exports.canStale = axios_cache_interceptor_1.canStale;
    ...
    constructor({ clientId, secret, authBaseUrl, callbackUrl, debug, cache, unsafeIncludeUser }) {
        ...
        this.getDecodedToken = () => __awaiter(this, void 0, void 0, function* () {
            try {
                //Decode the JWT
                const textEncoder = new TextEncoder();
                const { payload: decodedToken } = yield (0, jose_1.jwtDecrypt)(this.token, textEncoder.encode(this.secret));
                return decodedToken;
            }
            catch (error) {
                if (this.debug)
        ...
        this.getUser = (headers) => __awaiter(this, void 0, void 0, function* () {
            if (this.userData)
                ...
                if (this.unsafeIncludeUser && user)
                    ...
                    this.userData = yield this.getUserFromServer(headers, this.token);
                }
            }
        });
        ...
        this.getUserFromServer = (headers, token) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            try {
                const response = yield this.axios.post(requestUrl.toString(), token, {
...
window.addEventListener("message", ({data}) => document.getElementById("centralauth-embedded-login").style.height = data + "px");`;
        ...
        this.login = (req, config) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (config === null || config === void 0 ? void 0 : config.affirmExistingSession)
        ...
        this.processCallback = (req, onStateReceived) => __awaiter(this, void 0, void 0, function* () {
            ...
            const existingUserData = affirmExistingSession ? yield this.getUserData(req.headers) : null;
            ...
            if (affirmExistingSession) {
                ...
                const newUserData = yield this.getUserFromServer(req.headers, newToken);
                ...
                if ((existingUserData === null || existingUserData === void 0 ? void 0 : existingUserData.email) !== newUserData.email)
        ...
        this.debug = debug;
        this.cache = cache;
        this.axios = (0, axios_cache_interceptor_1.setupCache)(this.instance, {
            methods: ['get', 'post'],
            ttl: (cache === null || cache === void 0 ? void 0 : cache.ttl) || 0,
            storage: cache ? (0, axios_cache_interceptor_1.buildStorage)(cache.storage) : (0, axios_cache_interceptor_1.buildMemoryStorage)()
        });
...
class CentralAuthHTTPClass extends CentralAuthClass {
    constructor() {
        super(...arguments);
...
exports.CentralAuthHTTPClass = CentralAuthHTTPClass;
